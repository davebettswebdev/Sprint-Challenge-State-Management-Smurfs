...
- [X] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
      ...
      Redux-thunk is middleware that allows us to call action creators to return a function instead of an action object through dispatch.

- [X] What is your favorite state management system you've learned and this sprint? Please explain why!

      I think context although redux isn't as bad as I thought it would be. 
